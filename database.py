        ...
        try:
            ...
            if "mongodb+srv://" in uri:
                ...
                if "?" not in uri:
                    ...
                    uri = uri.rstrip('/') + "/?retryWrites=true&w=majority&serverSelectionTimeoutMS=30000&connectTimeoutMS=30000&socketTimeoutMS=30000"
                else:
                    # 기존 옵션에 필요한 파라미터 추가
            ...
            print(f"MongoDB 연결 시도 중... (URI 형식 확인됨)")
